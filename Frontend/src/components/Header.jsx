...
const Header = () => {
  ...
  return (
    <div className='flex flex-col items-center mt-20 px-4 text-center text-gray-800'>
      ...
      <h1 className='flex items-center gap-2 text-xl sm:text-3xl font-medium mb-2'>Hey {userData ? userData.name : 'Daiki'}!
      ...
      <p className='mb-8 max-w-md'>Lorem, ipsum dolor sit amet consectetur adipisicing elit.
         Dolor ad accusantium nam voluptatum blanditiis? Libero, reiciendis nulla! Neque!</p>
